...
namespace Vrmac
{
	/// <summary>Format of the swap chain’s buffers; has both color depth, and MSAA values.</summary>
	/// <remarks>Only supports a single render target for the color.</remarks>
	public struct SwapChainFormats
	{
		...
		public SwapChainFormats( TextureFormat color, TextureFormat depth, byte sampleCount )
		{
			this.color = color;
			this.depth = depth;
