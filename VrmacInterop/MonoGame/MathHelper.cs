...
namespace Diligent.Graphics
{
	...
	public static class MathHelper
	{
		...
		/// <summary>Represents the value of pi times two(6.28318548).
		/// This is an alias of TwoPi.</summary>
		...
		/// <remarks>This method uses double precision internally, though it returns single float</remarks>
