...
namespace Diligent.Graphics
{
	...
	{
		/// <summary>Returns a value indicating what side (positive/negative) of a plane a point is</summary>
		...
		/// <summary>Returns the perpendicular distance from a point to a plane</summary>
	...
	public struct Plane: IEquatable<Plane>
	{
		...
		/// <summary>Create a <see cref="Plane"/> that contains the specified point and has the specified <see cref="Normal"/> vector.</summary>
		...
		/// <summary>Deconstruction method for <see cref="Plane"/>.</summary>
