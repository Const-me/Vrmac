...
{
	/// <summary>Represents the right-handed 4x4 floating point matrix, which can store translation, scale and rotation information.</summary>
	...
	public struct Matrix: IEquatable<Matrix>
	{
		...
		/// <summary>Get matrix element by the linear index, which must be in [ 0 .. 15 ] interval</summary>
		...
		/// <summary>Get matrix element by the 2D index, each one must be in [ 0 .. 3 ] interval</summary>
			...
			ref Vector3 cameraUpVector, Vector3? cameraForwardVector, out Matrix result )
		{
			...
			{
				Vector3.Multiply( ref vector, 1.0f / MathF.Sqrt( num ), out vector );
			}
			...
			ref Vector3 rotateAxis, Vector3? cameraForwardVector, Vector3? objectForwardVector, out Matrix result )
		{
			...
			{
				Vector3.Multiply( ref vector2, 1.0f / MathF.Sqrt( num2 ), out vector2 );
			}
		...
		/// <summary>Creates a new rotation <see cref="Matrix"/> from a <see cref="Quaternion"/>.</summary>
		...
		/// <summary>Creates a new rotation <see cref="Matrix"/> from the specified yaw, pitch and roll values.</summary>
		...
		/// <param name="nearPlaneDistance">Distance to the near plane.</param>
		/// <param name="farPlaneDistance">Distance to the far plane.</param>
		/// <param name="openGlVariant">True to use OpenGL/GLES format for the projection matrix, false to use Direct3D convention.</param>
		/// <returns>The new projection <see cref="Matrix"/> for perspective view with FOV.</returns>
		public static Matrix CreatePerspectiveFieldOfView( float fieldOfView, float aspectRatio, float nearPlaneDistance, float farPlaneDistance, bool openGlVariant )
		{
			Matrix result;
			CreatePerspectiveFieldOfView( fieldOfView, aspectRatio, nearPlaneDistance, farPlaneDistance, openGlVariant, out result );
			return result;
		}
		...
		public static void CreatePerspectiveFieldOfView( float fieldOfView, float aspectRatio, float nearPlaneDistance, float farPlaneDistance, bool openGlVariant, out Matrix result )
		{
		...
		/// <summary>Creates a new <see cref="Matrix"/> that flattens geometry into a specified <see cref="Plane"/> as if casting a shadow from a specified light source.</summary>
		...
		/// <summary>Creates a new reflection <see cref="Matrix"/>.</summary>
		...
		/// <summary>Decomposes this matrix to translation, rotation and scale elements. Returns <c>true</c> if matrix can be decomposed; <c>false</c> otherwise.</summary>
		...
		/// <summary>Returns a <see cref="String"/> representation of this <see cref="Matrix"/> in the format:
		...
		/// {M41:[<see cref="M41"/>] M42:[<see cref="M42"/>] M43:[<see cref="M43"/>] M44:[<see cref="M44"/>]}</summary>
		...
		/// <summary>Helper method for using the Laplace expansion theorem using two rows expansions to calculate major and 
		/// minor determinants of a 4x4 matrix. This method is used for inverting a matrix.</summary>
