...
{
	/// <summary>Defines a viewing frustum for intersection operations.</summary>
	...
	public class BoundingFrustum: IEquatable<BoundingFrustum>
	{
		...
		/// <summary>The number of planes in the frustum.</summary>
		public const int PlaneCount = 6;

		/// <summary>The number of corner points in the frustum.</summary>
		public const int CornerCount = 8;

		/// <summary>Gets or sets the <see cref="Matrix"/> of the frustum.</summary>
		...
		/// <summary>Gets the near plane of the frustum.</summary>
		public Plane Near
		{
			get { return _planes[ 0 ]; }
		}

		/// <summary>Gets the far plane of the frustum.</summary>
		public Plane Far
		{
			get { return _planes[ 1 ]; }
		}

		/// <summary>Gets the left plane of the frustum.</summary>
		public Plane Left
		{
			get { return _planes[ 2 ]; }
		}

		/// <summary>Gets the right plane of the frustum.</summary>
		public Plane Right
		{
			get { return _planes[ 3 ]; }
		}

		/// <summary>Gets the top plane of the frustum.</summary>
		public Plane Top
		{
			get { return _planes[ 4 ]; }
		}

		/// <summary>Gets the bottom plane of the frustum.</summary>
		public Plane Bottom
		{
		...
		/// <summary>Constructs the frustum by extracting the view planes from a matrix.</summary>
		...
		/// <summary>Compares whether two <see cref="BoundingFrustum"/> instances are equal.</summary>
		...
		/// <summary>Compares whether two <see cref="BoundingFrustum"/> instances are not equal.</summary>
		...
		/// <summary>Containment test between this <see cref="BoundingFrustum"/> and specified <see cref="BoundingBox"/>.</summary>
		...
		/// <summary>Containment test between this <see cref="BoundingFrustum"/> and specified <see cref="BoundingFrustum"/>.</summary>
		...
		/// <summary>Containment test between this <see cref="BoundingFrustum"/> and specified <see cref="BoundingSphere"/>.</summary>
		...
		/// <summary>Containment test between this <see cref="BoundingFrustum"/> and specified <see cref="Vector3"/>.</summary>
		...
		/// <summary>Compares whether current instance is equal to specified <see cref="BoundingFrustum"/>.</summary>
		...
		/// <summary>Returns a copy of internal corners array.</summary>
		...
		/// <summary>Gets the hash code of this <see cref="BoundingFrustum"/>.</summary>
		...
		/// <summary>Gets whether or not a specified <see cref="BoundingBox"/> intersects with this <see cref="BoundingFrustum"/>.</summary>
		...
		/// <summary>Gets whether or not a specified <see cref="BoundingFrustum"/> intersects with this <see cref="BoundingFrustum"/>.</summary>
		...
		/// <summary>Gets whether or not a specified <see cref="BoundingSphere"/> intersects with this <see cref="BoundingFrustum"/>.</summary>
		...
		/// <summary>Gets type of intersection between specified <see cref="Plane"/> and this <see cref="BoundingFrustum"/>.</summary>
		...
		/// <summary>Gets the distance of intersection of <see cref="Ray"/> and this <see cref="BoundingFrustum"/> or null if no intersection happens.</summary>
		...
		/// <summary>Returns a <see cref="String"/> representation of this <see cref="BoundingFrustum"/> in the format:
		/// {Near:[nearPlane] Far:[farPlane] Left:[leftPlane] Right:[rightPlane] Top:[topPlane] Bottom:[bottomPlane]}</summary>
