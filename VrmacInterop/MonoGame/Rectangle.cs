...
namespace Diligent.Graphics
{
	...
	public struct Rectangle: IEquatable<Rectangle>
	{
		...
		/// <summary>The x coordinate of the top-left corner of this <see cref="Rectangle"/>.</summary>
		[DataMember]
		public int X;

		/// <summary>The y coordinate of the top-left corner of this <see cref="Rectangle"/>.</summary>
		[DataMember]
		public int Y;

		/// <summary>The width of this <see cref="Rectangle"/>.</summary>
		[DataMember]
		public int Width;

		/// <summary>The height of this <see cref="Rectangle"/>.</summary>
		[DataMember]
		public int Height;

		/// <summary>Returns a <see cref="Rectangle"/> with X=0, Y=0, Width=0, Height=0.</summary>
		public static Rectangle Empty { get; } = new Rectangle();

		/// <summary>Returns the x coordinate of the left edge of this <see cref="Rectangle"/>.</summary>
		public int Left
		{
			get { return X; }
		}

		/// <summary>Returns the x coordinate of the right edge of this <see cref="Rectangle"/>.</summary>
		public int Right
		{
			get { return ( X + Width ); }
		}

		/// <summary>Returns the y coordinate of the top edge of this <see cref="Rectangle"/>.</summary>
		public int Top
		{
			get { return Y; }
		}

		/// <summary>Returns the y coordinate of the bottom edge of this <see cref="Rectangle"/>.</summary>
		public int Bottom
		{
			get { return ( Y + Height ); }
		}

		/// <summary>Whether or not this <see cref="Rectangle"/> has a <see cref="Width"/> and
		/// <see cref="Height"/> of 0, and a <see cref="Location"/> of (0, 0).</summary>
		public bool IsEmpty
		{
			get
			{
		...
		/// <summary>The top-left coordinates of this <see cref="Rectangle"/>.</summary>
		...
		/// <summary>The width-height coordinates of this <see cref="Rectangle"/>.</summary>
		public Point Size
		{
			get
			{
		...
		/// <summary>A <see cref="Point"/> located in the center of this <see cref="Rectangle"/>.</summary>
		/// <remarks>
		...
		/// <summary>Creates a new instance of <see cref="Rectangle"/> struct, with the specified
		/// position, width, and height.</summary>
		...
		/// <summary>Compares whether two <see cref="Rectangle"/> instances are equal.</summary>
		...
		/// <summary>Compares whether two <see cref="Rectangle"/> instances are not equal.</summary>
		...
		/// <summary>Gets whether or not the provided coordinates lie within the bounds of this <see cref="Rectangle"/>.</summary>
		...
		/// <summary>Gets whether or not the provided <see cref="Point"/> lies within the bounds of this <see cref="Rectangle"/>.</summary>
		...
		/// <summary>Gets whether or not the provided <see cref="Vector2"/> lies within the bounds of this <see cref="Rectangle"/>.</summary>
		/// <param name="value">The coordinates to check for inclusion in this <see cref="Rectangle"/>.</param>
		...
		/// <summary>Gets whether or not the provided <see cref="Rectangle"/> lies within the bounds of this <see cref="Rectangle"/>.</summary>
		...
		/// <summary>Compares whether current instance is equal to specified <see cref="Rectangle"/>.</summary>
		...
		/// <summary>Gets the hash code of this <see cref="Rectangle"/>.</summary>
		...
		/// <summary>Adjusts the edges of this <see cref="Rectangle"/> by specified horizontal and vertical amounts.</summary>
		...
		/// <summary>Creates a new <see cref="Rectangle"/> that contains overlapping region of two other rectangles.</summary>
		...
		/// <summary>Changes the <see cref="Location"/> of this <see cref="Rectangle"/>.</summary>
		...
		/// <summary>Returns a <see cref="String"/> representation of this <see cref="Rectangle"/> in the format:
		/// {X:[<see cref="X"/>] Y:[<see cref="Y"/>] Width:[<see cref="Width"/>] Height:[<see cref="Height"/>]}</summary>
		...
		/// <summary>Creates a new <see cref="Rectangle"/> that completely contains two other rectangles.</summary>
		/// <param name="value1">The first <see cref="Rectangle"/>.</param>
		/// <param name="value2">The second <see cref="Rectangle"/>.</param>
		...
		/// <summary>Deconstruction method for <see cref="Rectangle"/>.</summary>
		/// <param name="x"></param>
		/// <param name="y"></param>
