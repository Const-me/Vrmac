...
{
	/// <summary>Describes a 4D-vector.</summary>
	...
	public struct Vector4: IEquatable<Vector4>
	{
		...
		/// <summary>The x coordinate of this <see cref="Vector4"/>.</summary>
		[DataMember]
		public float X;

		/// <summary>The y coordinate of this <see cref="Vector4"/>.</summary>
		[DataMember]
		public float Y;

		/// <summary>The z coordinate of this <see cref="Vector4"/>.</summary>
		[DataMember]
		public float Z;

		/// <summary>The w coordinate of this <see cref="Vector4"/>.</summary>
		[DataMember]
		public float W;

		/// <summary>Returns a <see cref="Vector4"/> with components 0, 0, 0, 0.</summary>
		public static Vector4 Zero { get; } = new Vector4();

		/// <summary>Returns a <see cref="Vector4"/> with components 1, 1, 1, 1.</summary>
		public static Vector4 One { get; } = new Vector4( 1f, 1f, 1f, 1f );

		/// <summary>Returns a <see cref="Vector4"/> with components 1, 0, 0, 0.</summary>
		public static Vector4 UnitX { get; } = new Vector4( 1f, 0f, 0f, 0f );

		/// <summary>Returns a <see cref="Vector4"/> with components 0, 1, 0, 0.</summary>
		public static Vector4 UnitY { get; } = new Vector4( 0f, 1f, 0f, 0f );

		/// <summary>Returns a <see cref="Vector4"/> with components 0, 0, 1, 0.</summary>
		public static Vector4 UnitZ { get; } = new Vector4( 0f, 0f, 1f, 0f );

		/// <summary>Returns a <see cref="Vector4"/> with components 0, 0, 0, 1.</summary>
		...
		/// <summary>Constructs a 3d vector with X, Y, Z and W from four values.</summary>
		...
		/// <summary>Constructs a 3d vector with X and Z from <see cref="Vector2"/> and Z and W from the scalars.</summary>
		...
		/// <summary>Constructs a 3d vector with X, Y, Z from <see cref="Vector3"/> and W from a scalar.</summary>
		...
		/// <summary>Constructs a 4d vector with X, Y, Z and W set to the same value.</summary>
		...
		/// <summary>Performs vector addition on <paramref name="value1"/> and
		/// <paramref name="value2"/>, storing the result of the
		/// addition in <paramref name="result"/>.</summary>
		/// <param name="value1">The first vector to add.</param>
		/// <param name="value2">The second vector to add.</param>
		...
		/// <summary>Creates a new <see cref="Vector4"/> that contains the cartesian coordinates of a vector specified in barycentric coordinates and relative to 4d-triangle.</summary>
		...
		/// <summary>Creates a new <see cref="Vector4"/> that contains CatmullRom interpolation of the specified vectors.</summary>
		...
		/// <summary>Round the members of this <see cref="Vector4"/> towards positive infinity.</summary>
		public void Ceiling()
		{
			X = MathF.Ceiling( X );
			Y = MathF.Ceiling( Y );
		...
		/// <summary>Creates a new <see cref="Vector4"/> that contains members from another vector rounded towards positive infinity.</summary>
		...
		/// <summary>Divides the components of a <see cref="Vector4"/> by the components of another <see cref="Vector4"/>.</summary>
		...
		/// <summary>Divides the components of a <see cref="Vector4"/> by a scalar.</summary>
		/// <param name="value1">Source <see cref="Vector4"/>.</param>
		...
		/// <summary>Compares whether current instance is equal to specified <see cref="Vector4"/>.</summary>
		...
		/// <summary>Round the members of this <see cref="Vector4"/> towards negative infinity.</summary>
		public void Floor()
		{
			X = MathF.Floor( X );
			Y = MathF.Floor( Y );
		...
		/// <summary>Creates a new <see cref="Vector4"/> that contains members from another vector rounded towards negative infinity.</summary>
		/// <param name="value">Source <see cref="Vector4"/>.</param>
		/// <returns>The rounded <see cref="Vector4"/>.</returns>
		...
		/// <summary>Gets the hash code of this <see cref="Vector4"/>.</summary>
		...
		/// <summary>Creates a new <see cref="Vector4"/> that contains hermite spline interpolation.</summary>
		...
		/// <summary>Returns the length of this <see cref="Vector4"/>.</summary>
		...
		/// <summary>Returns the squared length of this <see cref="Vector4"/>.</summary>
		...
		/// <summary>Creates a new <see cref="Vector4"/> that contains linear interpolation of the specified vectors.</summary>
		/// <param name="value1">The first vector.</param>
		/// <param name="value2">The second vector.</param>
		...
		/// <summary>Creates a new <see cref="Vector4"/> that contains linear interpolation of the specified vectors.
		...
		/// See remarks section of <see cref="MathHelper.LerpPrecise"/> on MathHelper for more info.</summary>
		/// <param name="value1">The first vector.</param>
		/// <param name="value2">The second vector.</param>
		/// <param name="amount">Weighting value(between 0.0 and 1.0).</param>
		/// <returns>The result of linear interpolation of the specified vectors.</returns>
		...
		/// <summary>Creates a new <see cref="Vector4"/> that contains a maximal values from the two vectors.</summary>
		/// <param name="value1">The first vector.</param>
		/// <param name="value2">The second vector.</param>
		...
		/// <summary>Creates a new <see cref="Vector4"/> that contains a minimal values from the two vectors.</summary>
		/// <param name="value1">The first vector.</param>
		/// <param name="value2">The second vector.</param>
		...
		/// <summary>Creates a new <see cref="Vector4"/> that contains a multiplication of two vectors.</summary>
		/// <param name="value1">Source <see cref="Vector4"/>.</param>
		...
		/// <summary>Creates a new <see cref="Vector4"/> that contains a multiplication of <see cref="Vector4"/> and a scalar.</summary>
		/// <param name="value1">Source <see cref="Vector4"/>.</param>
		...
		/// <summary>Creates a new <see cref="Vector4"/> that contains the specified vector inversion.</summary>
		/// <param name="value">Source <see cref="Vector4"/>.</param>
		...
		/// <summary>Turns this <see cref="Vector4"/> to a unit vector with the same direction.</summary>
		...
		/// <summary>Creates a new <see cref="Vector4"/> that contains a normalized values from another vector.</summary>
		/// <param name="value">Source <see cref="Vector4"/>.</param>
		...
		/// <summary>Round the members of this <see cref="Vector4"/> to the nearest integer value.</summary>
		public void Round()
		{
			X = MathF.Round( X );
			Y = MathF.Round( Y );
		...
		/// <summary>Creates a new <see cref="Vector4"/> that contains members from another vector rounded to the nearest integer value.</summary>
		/// <param name="value">Source <see cref="Vector4"/>.</param>
		/// <returns>The rounded <see cref="Vector4"/>.</returns>
		...
		/// <summary>Creates a new <see cref="Vector4"/> that contains cubic interpolation of the specified vectors.</summary>
		/// <param name="value1">Source <see cref="Vector4"/>.</param>
		/// <param name="value2">Source <see cref="Vector4"/>.</param>
		...
		/// <summary>Creates a new <see cref="Vector4"/> that contains subtraction of on <see cref="Vector4"/> from a another.</summary>
		/// <param name="value1">Source <see cref="Vector4"/>.</param>
		/// <param name="value2">Source <see cref="Vector4"/>.</param>
		...
		/// <summary>Creates a new <see cref="Vector4"/> that contains a transformation of 2d-vector by the specified <see cref="Matrix"/>.</summary>
		...
		/// <summary>Creates a new <see cref="Vector4"/> that contains a transformation of 2d-vector by the specified <see cref="Quaternion"/>.</summary>
		/// <param name="value">Source <see cref="Vector2"/>.</param>
		...
		/// <summary>Creates a new <see cref="Vector4"/> that contains a transformation of 3d-vector by the specified <see cref="Matrix"/>.</summary>
		...
		/// <summary>Creates a new <see cref="Vector4"/> that contains a transformation of 3d-vector by the specified <see cref="Quaternion"/>.</summary>
		/// <param name="value">Source <see cref="Vector3"/>.</param>
		/// <param name="rotation">The <see cref="Quaternion"/> which contains rotation transformation.</param>
		/// <returns>Transformed <see cref="Vector4"/>.</returns>
		...
		/// <summary>Creates a new <see cref="Vector4"/> that contains a transformation of 4d-vector by the specified <see cref="Matrix"/>.</summary>
		/// <param name="value">Source <see cref="Vector4"/>.</param>
		/// <param name="matrix">The transformation <see cref="Matrix"/>.</param>
		/// <returns>Transformed <see cref="Vector4"/>.</returns>
		...
		/// <summary>Creates a new <see cref="Vector4"/> that contains a transformation of 4d-vector by the specified <see cref="Quaternion"/>.</summary>
		/// <param name="value">Source <see cref="Vector4"/>.</param>
		/// <param name="rotation">The <see cref="Quaternion"/> which contains rotation transformation.</param>
		/// <returns>Transformed <see cref="Vector4"/>.</returns>
		...
		/// <summary>Apply transformation on vectors within array of <see cref="Vector4"/> by the specified <see cref="Matrix"/> and places the results in an another array.</summary>
		...
		/// <summary>Apply transformation on vectors within array of <see cref="Vector4"/> by the specified <see cref="Quaternion"/> and places the results in an another array.</summary>
		/// <param name="sourceArray">Source array.</param>
		/// <param name="sourceIndex">The starting index of transformation in the source array.</param>
		/// <param name="rotation">The <see cref="Quaternion"/> which contains rotation transformation.</param>
		/// <param name="destinationArray">Destination array.</param>
		...
		/// <summary>Apply transformation on all vectors within array of <see cref="Vector4"/> by the specified <see cref="Matrix"/> and places the results in an another array.</summary>
		/// <param name="sourceArray">Source array.</param>
		/// <param name="matrix">The transformation <see cref="Matrix"/>.</param>
		/// <param name="destinationArray">Destination array.</param>
		...
		/// <summary>Apply transformation on all vectors within array of <see cref="Vector4"/> by the specified <see cref="Quaternion"/> and places the results in an another array.</summary>
		/// <param name="sourceArray">Source array.</param>
		/// <param name="rotation">The <see cref="Quaternion"/> which contains rotation transformation.</param>
		/// <param name="destinationArray">Destination array.</param>
		...
		/// <summary>Returns a <see cref="String"/> representation of this <see cref="Vector4"/> in the format:
		...
		/// <summary>Deconstruction method for <see cref="Vector4"/>.</summary>
		/// <param name="x"></param>
		/// <param name="y"></param>
		/// <param name="z"></param>
		/// <param name="w"></param>
		...
		/// <summary>Inverts values in the specified <see cref="Vector4"/>.</summary>
		...
		/// <summary>Compares whether two <see cref="Vector4"/> instances are equal.</summary>
		...
		/// <summary>Compares whether two <see cref="Vector4"/> instances are not equal.</summary>
		...
		/// <summary>Subtracts a <see cref="Vector4"/> from a <see cref="Vector4"/>.</summary>
		...
		/// <summary>Construct from span of floats</summary>
		public Vector4( ReadOnlySpan<float> span )
		{
			X = span[ 0 ];
			Y = span[ 1 ];
			Z = span[ 2 ];
		...
		/// <summary>Absolute value of all coordinates</summary>
		...
		public float maxCoordinate => MathF.Max( MathF.Max( X, Y ), MathF.Max( Z, W ) );
	}
}