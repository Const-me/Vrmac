...
{
	/// <summary>Describes a 2D-point.</summary>
	[StructLayout( LayoutKind.Sequential ), DataContract, DebuggerDisplay( "{DebugDisplayString,nq}" )]
	public struct Point: IEquatable<Point>
	{

		/// <summary>The x coordinate of this <see cref="Point"/>.</summary>
		[DataMember]
		public int X;

		/// <summary>The y coordinate of this <see cref="Point"/>.</summary>
		[DataMember]
		public int Y;

		/// <summary>Returns a <see cref="Point"/> with coordinates 0, 0.</summary>
		...
		/// <summary>Constructs a point with X and Y from two values.</summary>
		...
		/// <summary>Constructs a point with X and Y set to the same value.</summary>
		...
		/// <summary>Subtracts a <see cref="Point"/> from a <see cref="Point"/>.</summary>
		...
		/// <summary>Multiplies the components of two points by each other.</summary>
		...
		/// <summary>Divides the components of a <see cref="Point"/> by the components of another <see cref="Point"/>.</summary>
		...
		/// <summary>Compares whether two <see cref="Point"/> instances are equal.</summary>
		...
		/// <summary>Compares whether two <see cref="Point"/> instances are not equal.</summary>
		...
		/// <summary>Compares whether current instance is equal to specified <see cref="Point"/>.</summary>
		...
		/// <summary>Gets the hash code of this <see cref="Point"/>.</summary>
		...
		/// <summary>Returns a <see cref="String"/> representation of this <see cref="Point"/> in the format:
		...
		/// <summary>Gets a <see cref="Vector2"/> representation for this object.</summary>
		...
		/// <summary>Deconstruction method for <see cref="Point"/>.</summary>
		/// <param name="x"></param>
		/// <param name="y"></param>
