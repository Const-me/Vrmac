...
{
	/// <summary>Describes a sphere in 3D-space for bounding operations.</summary>
	[StructLayout( LayoutKind.Sequential ), DataContract, DebuggerDisplay( "{DebugDisplayString,nq}" )]
	public struct BoundingSphere: IEquatable<BoundingSphere>
	{
		/// <summary>The sphere center.</summary>
		[DataMember]
		...
		/// <summary>Constructs a bounding sphere with the specified center and radius.</summary>
		...
		/// <summary>Test if a bounding box is fully inside, outside, or just intersecting the sphere.</summary>
		...
		/// <summary>Test if a frustum is fully inside, outside, or just intersecting the sphere.</summary>
		...
		/// <summary>Test if a sphere is fully inside, outside, or just intersecting the sphere.</summary>
		...
		/// <summary>Test if a point is fully inside, outside, or just intersecting the sphere.</summary>
		...
		/// <summary>Creates the smallest <see cref="BoundingSphere"/> that can contain a specified <see cref="BoundingBox"/>.</summary>
		...
		/// <summary>Creates the smallest <see cref="BoundingSphere"/> that can contain a specified <see cref="BoundingFrustum"/>.</summary>
		...
		/// <summary>Creates the smallest <see cref="BoundingSphere"/> that can contain a specified list of points in 3D-space.</summary>
		...
		/// <summary>Creates the smallest <see cref="BoundingSphere"/> that can contain two spheres.</summary>
		...
		/// <summary>Compares whether current instance is equal to specified <see cref="BoundingSphere"/>.</summary>
		...
		/// <summary>Gets the hash code of this <see cref="BoundingSphere"/>.</summary>
		...
		/// <summary>Gets whether or not a specified <see cref="BoundingBox"/> intersects with this sphere.</summary>
		/// <param name="box">The box for testing.</param>
        ...
        */
		...
		/// <summary>Gets whether or not the other <see cref="BoundingSphere"/> intersects with this sphere.</summary>
		/// <param name="sphere">The other sphere for testing.</param>
		...
		/// <summary>Gets whether or not a specified <see cref="Plane"/> intersects with this sphere.</summary>
		...
		/// <summary>Gets whether or not a specified <see cref="Ray"/> intersects with this sphere.</summary>
		...
		/// <summary>Returns a <see cref="String"/> representation of this <see cref="BoundingSphere"/> in the format:
		/// {Center:[<see cref="Center"/>] Radius:[<see cref="Radius"/>]}</summary>
		...
		/// <summary>Creates a new <see cref="BoundingSphere"/> that contains a transformation of translation and scale from this sphere by the specified <see cref="Matrix"/>.</summary>
		...
		public BoundingSphere Transform( Matrix matrix )
		{
			...
			sphere.Radius = Radius * ( MathF.Sqrt( MathF.Max( ( ( matrix.M11 * matrix.M11 ) + ( matrix.M12 * matrix.M12 ) ) + ( matrix.M13 * matrix.M13 ), MathF.Max( ( ( matrix.M21 * matrix.M21 ) + ( matrix.M22 * matrix.M22 ) ) + ( matrix.M23 * matrix.M23 ), ( ( matrix.M31 * matrix.M31 ) + ( matrix.M32 * matrix.M32 ) ) + ( matrix.M33 * matrix.M33 ) ) ) ) );
			return sphere;
		}
		...
		public void Transform( ref Matrix matrix, out BoundingSphere result )
		{
			...
			result.Radius = Radius * ( MathF.Sqrt( MathF.Max( ( ( matrix.M11 * matrix.M11 ) + ( matrix.M12 * matrix.M12 ) ) + ( matrix.M13 * matrix.M13 ), MathF.Max( ( ( matrix.M21 * matrix.M21 ) + ( matrix.M22 * matrix.M22 ) ) + ( matrix.M23 * matrix.M23 ), ( ( matrix.M31 * matrix.M31 ) + ( matrix.M32 * matrix.M32 ) ) + ( matrix.M33 * matrix.M33 ) ) ) ) );
		}

		/// <summary>Deconstruction method for <see cref="BoundingSphere"/>.</summary>
		...
		/// <summary>Compares whether two <see cref="BoundingSphere"/> instances are equal.</summary>
		...
		/// <summary>Compares whether two <see cref="BoundingSphere"/> instances are not equal.</summary>
